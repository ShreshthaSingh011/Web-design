...
In this course, I built a balance sheet using pseudo selectors. I leanned how to change the style of an element when we hover over it with oour mouse, and trigger other events on oour webpage.
